...
export class WatchdogManager {
    static disableWatchdog() {
        ...
        try {
            ...
            system.runTimeout = function (callback, tickDelay) {
                try {
            ...
            system.runInterval = function (callback, tickInterval) {
                const safeCallback = () => {
                    try {
                        callback();
                    }
    ...
    static getBlockedEvents() {
        return [...this.watchdogEvents];
    }
    static isWatchdogDisabled() {
...
WatchdogManager.isDisabled = false;
WatchdogManager.watchdogEvents = [];
