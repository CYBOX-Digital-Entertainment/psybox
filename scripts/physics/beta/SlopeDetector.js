...
export class SlopeDetector {
    ...
    static calculateSlopeInfo(entityPos, blockPos, blockType, direction) {
        let heightDiff = 0;
        let distance = 1.0;
        // 블록 타입별 높이 계산
    ...
    static isSlopeBlock(blockType) {
        return this.SLOPE_BLOCKS.has(blockType);
    }
    static getSupportedBlocks() {
        return Array.from(this.SLOPE_BLOCKS);
    }
}
SlopeDetector.SLOPE_BLOCKS = new Set([
